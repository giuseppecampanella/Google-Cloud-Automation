...
const NAME_COL = "Name";
const PATH_COL = "Fast Track / Tech Lead";
const EMAIL_SENT_COL = "Email Sent";
const ATTACHMENT_COL = "Attachment ID"
const MAIL_SUBJECT = "Lettera Variazione_{path}_{full_name}";

const sheets = ["AUMENTO RAL", "AUMENTO RAL+LIVELLO CCNL", "AUMENTO RAL+LIVELLO CCNL+CAREER PATH"];
...
*/
function sendEmails(subjectLine) {
    ...
    obj.forEach(function (row, rowIdx) {
      ...
      if (row[EMAIL_SENT_COL] == '') {
        try {
          ...
          const attachmentFromGoogleDrive = DriveApp.getFileById(row[ATTACHMENT_COL]);

          const mailSubject = MAIL_SUBJECT.replace("{path}", row[PATH_COL]).replace("{full_name}", row[NAME_COL]);

          // @see https://developers.google.com/apps-script/reference/gmail/gmail-app#sendEmail(String,String,String,Object)
          // if you need to send emails with unicode/emoji characters change GmailApp for MailApp
          // Uncomment advanced parameters as needed (see docs for limitations)
          GmailApp.sendEmail(row[RECIPIENT_COL], mailSubject, msgObj.text, {
            ...
            attachments: attachmentFromGoogleDrive.getAs(MimeType.PDF),
